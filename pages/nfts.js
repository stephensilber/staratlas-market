...
export default function Home({ itemTypes, itemRarity, itemClasses, nfts }) {
  const { marketMap } = useContext(MarketFeedContext);
  ...
  console.log(`MARKETS:`, Object.values(marketMap));
                  ...
                  {nft.markets
                    ...
                    .map((market) => (
                      ...
                      >
                        {`$${
                          marketMap[market.id] &&
                          marketMap[market.id].bids[0][0]
                        } (${
                          marketMap[market.id] &&
                          marketMap[market.id].bids[0][1]
                        })`}
                      </Badge>
                    ))}
                </a>
